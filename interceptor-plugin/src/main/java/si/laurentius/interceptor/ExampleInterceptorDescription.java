...
public class ExampleInterceptorDescription extends  AbstractPluginDescription {

  private static final SEDLogger LOG = new SEDLogger(ExampleInterceptorDescription.class);
  ...
  private void postConstruct() {    
    try {      
      registerPluginComponentInterface(ExampleInterceptor.class);    
      // register plugin
      registerPlugin();
  ...
  public String getDesc() {
    return "Example interceptor plugin descriptor";
  }
  ...
  public String getType() {
    return "ExampleInterceptorPlugin";
  }
}
